...
Note that, due to low data size, changing the outliers from 1% to 5% changes the distribution, but Kentron remains at the top (expensive), and Gyumri at the bottom (affordable).
